...
public class ProductoRepository {
	...
	public List<Producto> listar() {
		...
		String sql = "select * from producto v join estado e on v.est_codigo=e.est_codigo join categoria c on v.cat_codigo=c.cat_codigo  where est_nombre='disponible'";
